export default {
  ...
  navBar: {
    ...
    extensionStore: {
      ...
      localInstall: "Install local plugin",
      manage: "Manage plugins",
      done: "Finish managing",
      refresh: "Refresh plugins",
      refreshPartialFailed: "Some plugin sources could not be refreshed; the last available content was retained",
      refreshFailed: "Plugin sources could not be refreshed; the last available content was retained",
      searchPlaceholder: "Search plugin name, description, or publisher",
    },
    pagesTitle: {
      sub: "Subscription",
      file: "File",
      ...
      logs: "Backend Logs",
      extensions: "Plugins",
      extensionDiscover: "Discover Plugins",
